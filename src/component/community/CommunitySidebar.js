const CommunitySidebar = () => {
    return (
        <div className="font-serif">
            <div className="w-full h-20 top-0 left-0 fixed">
                <img
            ...
            <aside
                id="default-sidebar"
                className="fixed top-20 left-0 z-40 w-60 h-screen "
            >
                <div className="h-full px-2 py-4 overflow-y-auto  bg-gray-50 dark:bg-gray-800">
                    <ul className="space-y-2 font-serif">
                        <li>
                            <a
                                href="/#"
                                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-lime-300 dark:hover:bg-gray-700"
                            >
                                <img
                                    className="h-7 w-7"
                        ...
                        <li>
                            ...
                            >
                                ...
                                <img
                                    className="items-center justify-center px-2 ml-10 text-sm  text-gray-800 bg-gray-200 rounded-full dark:bg-gray-700 dark:text-gray-300"
            ...
            <aside
                id="hover-sidebar"
                className="fixed top-48 left-0 z-40 w-60 h-screen"
                aria-label="Sidebar"
            >
