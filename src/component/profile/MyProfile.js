    ...
    return (
        <div>
                ...
                <div className=" gap-5 grid-cols-4 flex justify-start items-center  ">
                    <div>
                        <img
                            ...
                            className=" pr-0 md:w-[200px] md:h-[200px] object-cover rounded-full border-2 border-pink-600 p-1 ml-80  "
                            alt="logo"
                        />
                    </div>

                    <div className="ml-4 text-left pt-3 content-center">
                        <h2 className="text-3xl inline-block  md:mr-2 mb-2 font-bold sm:mb-0">
                            Quynh Huong
                        </h2>
            ...
            <div className="font-serif pt-[50px] pl-[250px]">
                ...
                <div className="pl-48 w-[700px] text-sm">
                ...
                <div className="pl-[300px] ">
                    <table class="text-xs my-6 text-left ">
                        <tbody>
                            <tr>
                                <td className="px-3 py-3 text-gray-400 font-semibold text-[13px]">
                                    Full Name{" "}
                                </td>
                                <td class="px-3 py-3 text-black font-bold text-[15px]">
                                    Quynh Huong
                                </td>
                            </tr>
                            <tr>
                                <td class="px-3 py-3 text-gray-400 font-semibold text-[13px]">
                                    UserName{" "}
                                </td>
