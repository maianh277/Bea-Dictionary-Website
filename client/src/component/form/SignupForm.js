...
const SignupForm = () => {
  ...
  return (
    <div className="w-1/3 md:w-3/4 sm:w-1/2 mx-auto my-5">
      <section className="bg-white pt-16">
        <div className="my-10">
          <div className="max-w-[500px] mx-auto ">
            <h1 className="text-center text-[30px] md:text-[35px] sm:text-[30px] tracking-tight text-gray-900 font-Lilita">
              {" "}
              CREATE NEW ACCOUNT
            </h1>
