    ...
    <div className="">
      <div className="pt-[120px] min-h-screen bg-white  mx-[150px] md:mx-[70px] sm:mx-[40px] p-10  shadow-xl">
        <h1 className="text-[30px] md:text-[23px] sm:text-[20px] text-teal-600 font-bold  flex items-center justify-center ">
          Terms and Conditions for Bea Dictionary
        </h1>
        ...
        <div className="mx-[120px] md:mx-[70px] sm:mx-[40px] my-5 leading-7 text-justify">
          <p>
            ...
            <span className="font-bold text-blue-500 ">Bea Dictionary</span>{" "}
          ...
          <div className="pl-5">
            <ul className="list-disc pl-2">
              <li>
                TThe Website and its contents, including but not limited to
                text, images, graphics, logos, and software, are protected by
                copyright and other intellectual property laws.
              </li>
              <li>
                You may not reproduce, modify, distribute, or exploit any part
                of the Website without prior written permission from us.
              </li>
            </ul>
          </div>
          ...
          <div className="pl-5">
            <ul className="list-disc pl-2">
              ...
              <li>
                ...
                ensure that it does not infringe any third-party rights or
          ...
          <div className="pl-5">
            <ul className="list-disc pl-2">
              <li>
                The Website is provided on an "as is" basis, and we make no
                representations or warranties of any kind, express or implied,
                regarding its accuracy, availability, or reliability.
              </li>
              <li>
                {" "}
          ...
          <div className="pl-5">
            <ul className="list-disc pl-2">
              <li>
                ...
                services. We have no control over the content or practices of
                these websites and disclaim any responsibility for them.
              </li>
              <li>
                Your use of any third-party websites is subject to their
          ...
          <div className="pl-5">
            <ul className="list-disc pl-2">
              <li>
                ...
                the Website. Your continued use of the Website after the
          ...
          <p className="mt-4">
            Please review our{" "}
            <Link to="/Policy">
              <span className="font-bold text-blue-500 hover:text-green-500">
                Privacy Policy
              </span>
            </Link>
          ...
          <p>
            ...
            <span className="font-bold text-blue-500">Terms & Conditions</span>,
            please contact us.
          </p>
        </div>
      </div>
