      ...
      {meanings.length === 0 ? (
        ...
        <div>
          <div className="flex gap-3">
            <h1 className="text-[45px] md:text-[35px] sm:text-[35px] text-teal-600 font-bold capitalize">
              {word}
            </h1>
            <div>
              {" "}
              {localStorage.getItem("id") ? (
                <i
                  className={`far fa-heart fa-xl mt-9 sm:mt-7 transition-all ease-in-out ${
